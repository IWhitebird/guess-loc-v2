...
function Auth() {
    ...
    return (
        <>
        <div className="px-5 flex items-center flex-col justify-center bg-gray-950 h-screen">
            ...
            </div>
            {
                ...
                (
                    <div className="bg-gray-800 p-10 rounded-2xl w-[500px]">
                    <h1 className="text-white text-3xl text-center">{formState === "login" ? "Login" : "Sign up"}</h1>
                    <form className="mt-6 flex flex-col gap-5">
                        {
                            formState === "signup" ? (
                                <>
                                    <label className="text-white text-xl">Name</label>
                                    <input className="p-2 rounded-md" type="text" name="name" id="name" onChange={handleChange} />
                                </>
                            ) : null
                        }
                        <label className="text-white text-xl">Email</label>
                        <input className="p-2 rounded-md" type="email" name="email" id="email" onChange={handleChange} />
                        <label className="text-white text-xl">Password</label>
                        <input className="p-2 rounded-md" type="password" name="password" id="password" onChange={handleChange} />

                        {
                            formState === "signup" ? (
                                <>
                                    <button className="bg-white border py-2 mt-3 w-full rounded-xl flex justify-center items-center text-sm hover:scale-105 duration-300 " onClick={handleSignSubmit}>
                                        <span className="text-lg">Sign up</span>
                                    </button>
                                </>
                            ) : (
                                <button className="bg-white border py-2 mt-3 w-full rounded-xl flex justify-center items-center text-sm hover:scale-105 duration-300 " onClick={handleLoginSubmit}>
                    ...
                    <button className="bg-white border py-2 w-full rounded-xl flex justify-center items-center text-sm hover:scale-105 duration-300" onClick={() => OAuthLogin("google")}>
