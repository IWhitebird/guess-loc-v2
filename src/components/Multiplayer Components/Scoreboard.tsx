...
export default function Scoreboard({ userRoundDetails }: any) {
    ...
    console.log("UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU " , {userRoundDetails})
    ...
    return (
        <div className="absolute w-auto p-5 z-40 py-3 text-black rounded-3xl bg-[rgba(50,50,50,0.1)] backdrop-blur-lg border-gray-300 border flex flex-col gap-3 left-3 top-3">
            ...
            {userRoundDetails && userRoundDetails.map((roundDetails: any, index: number) => (
                <div className='flex gap-5' key={index}>
                    <img src={roundDetails.user_img ? 
                        roundDetails.user_img : `https://api.dicebear.com/6.x/personas/svg?seed=${roundDetails.user_name}`} 
